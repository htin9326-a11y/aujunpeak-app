...
const GAMES = [
  ...
  },
  {
    ...
    name: "PUBG Mobile",
    short: "PB",
    logo: "https://upload.wikimedia.org/wikipedia/en/4/44/PlayerUnknown%27s_Battlegrounds_Mobile.webp",
    color: "#facc15",
    tier: "Supported",
    fps: "60",
    ping: 12,
  ...
  },
  {
    ...
    name: "Call of Duty",
    short: "CD",
    logo: "https://play-lh.googleusercontent.com/4KLtYEExeMc9gcYZz1BgAiV87IZ8onX3aGld_lJ8xMydt1MP7m--a6dn0aGNMemq-IiwGrrhqt81TA-Qbve8",
    color: "#00E5FF",
    tier: "Supported",
    fps: "60",
    ping: 15,
